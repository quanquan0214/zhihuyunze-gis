# 从D:/Google/H5/Depth_mask中读取栅格影像（都是类似于Depth_201802,Depth_201803这样的栅格影像，每张图只有一个波段），求均值并存储到csv文件中。
...
# 设置输入文件夹和输出表格路径
input_folder = "D:/Google/H5/Depthmask"  # 替换为实际文件夹路径
output_table = "D:/Google/Table/Depth_other_Ave.csv"  # 替换为实际输出路径
# 调用函数
